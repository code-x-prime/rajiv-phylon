...
import { categoriesApi, subCategoriesApi, productsApi, type Product, type ProductImage } from "@/lib/api";
...
function getInitialFormState(product: Product) {
  ...
  const existingSpecPairs = objToKVPairs(product.specifications);
  ...
  return {
    ...
    specPairs: existingSpecPairs.length ? existingSpecPairs : DEFAULT_SPEC_PAIRS,
    tradePairs: existingTradePairs.length ? existingTradePairs : DEFAULT_TRADE_PAIRS,
