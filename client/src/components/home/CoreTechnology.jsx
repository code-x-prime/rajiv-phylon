            ...
            return (
              ...
              >
                <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${seg.gradient} p-8 md:p-10 h-full transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.2)]`}>
                  ...
                  {/* Icon */}
                  <div className="w-12 h-12 rounded-xl bg-[#F5B400]/10 border border-[#F5B400]/20 flex items-center justify-center mb-6 group-hover:bg-[#F5B400] group-hover:border-[#F5B400] transition-all duration-500">
                    <Icon className="h-5 w-5 text-[#F5B400] group-hover:text-white transition-colors duration-500" />
                  </div>

                  {/* Name + subtitle */}
                  <h3 className="font-display font-medium text-xl md:text-2xl text-white tracking-[-0.02em] mb-1">
                    {seg.name}
                  </h3>
                  <p className="type-overline text-[#F5B400] mb-4">{seg.subtitle}</p>

                  {/* Tagline */}
                  <p className="font-display font-medium text-[15px] text-white/80 mb-2 leading-snug">
                    {seg.tagline}
                  </p>

                  {/* Description */}
                  <p className="text-[14px] text-white/45 font-body leading-relaxed">
                    {seg.description}
                  </p>
                </div>
              </motion.div>
