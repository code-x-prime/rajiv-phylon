...
import {
  Mail, Phone, MessageCircle, Loader2, SendHorizonal,
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <a
                    ...
                    className="flex flex-col items-center gap-1.5 rounded-xl border border-gray-200 py-3 hover:border-emerald-400 hover:bg-emerald-50 transition-all duration-200 group"
                  >
                    <MessageCircle className="h-4 w-4 text-emerald-500" />
                    <span className="text-[11px] font-heading font-semibold text-gray-500 group-hover:text-emerald-700">WhatsApp</span>
                  </a>
                  <a
